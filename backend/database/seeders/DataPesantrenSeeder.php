...
{
    /**
     * Sepuluh mata pelajaran plus sesuai data terbaru jadwal & rapor 2026/2027.
     * nama_ar/kelompok/kkm_default/urutan bisa diubah di menu admin (mapel-plus).
     */
    private const MAPELS = [
        ['kode' => 'BAGDADY', 'nama' => 'Bagdady', 'nama_ar' => 'البغدادية', 'kkm_default' => 70, 'urutan' => 1],
        ['kode' => 'QURAN', 'nama' => 'Qur\'an', 'nama_ar' => 'القرآن', 'kelompok' => 'tahfidz', 'kkm_default' => 75, 'urutan' => 2],
        ['kode' => 'JUZ_AMMA', 'nama' => 'Juz Amma', 'nama_ar' => 'جزء عمّ', 'kelompok' => 'tahfidz', 'kkm_default' => 75, 'urutan' => 3],
        ['kode' => 'HADITS', 'nama' => 'Hadits', 'nama_ar' => 'الحديث', 'kelompok' => 'kitab_kuning', 'kkm_default' => 70, 'urutan' => 4],
        ['kode' => 'TAUHID', 'nama' => 'Tauhid', 'nama_ar' => 'التوحيد', 'kkm_default' => 70, 'urutan' => 5],
        ['kode' => 'AKHLAK', 'nama' => 'Akhlaq', 'nama_ar' => 'الأخلاق', 'kelompok' => 'akhlak', 'kkm_default' => 70, 'urutan' => 6],
        ['kode' => 'FIQIH', 'nama' => 'Fiqih', 'nama_ar' => 'الفقه', 'kkm_default' => 70, 'urutan' => 7],
        ['kode' => 'NAHWU', 'nama' => 'Nahwu', 'nama_ar' => 'النحو', 'kelompok' => 'kitab_kuning', 'kkm_default' => 70, 'urutan' => 8],
        ['kode' => 'SHOROF', 'nama' => 'Shorof', 'nama_ar' => 'الصرف', 'kelompok' => 'kitab_kuning', 'kkm_default' => 70, 'urutan' => 9],
        ['kode' => 'P_SW', 'nama' => 'P. S&W', 'nama_ar' => 'الصلاة والوضوء', 'kkm_default' => 70, 'urutan' => 10],
    ];
    ...
    private const GURUS = [
        ...
        'ANIQOTUL' => ['nama' => 'ANIQOTUL UMMAH', 'mengajar' => ['Nahwu' => ['8C', '8D', '9C'], 'P. S&W' => ['7C', '7D'], 'Qur\'an' => ['9C'], 'Juz Amma' => ['9C']]],
        'MARYAM' => ['nama' => 'SITI MARYAM', 'mengajar' => ['Bagdady' => ['7C'], 'Juz Amma' => ['7D']]],
        'IBNU' => ['nama' => 'IBNU MUHAJAR', 'mengajar' => ['Bagdady' => ['7A', '7B']]],
        'SARIFAH' => ['nama' => 'SARIFAH', 'mengajar' => ['Bagdady' => ['7D']]],
    ];
    ...
    private const JADWAL = [
        ['Kamis', '7A', 'Bagdady', 'IBNU', '08:50', '09:25'],
        ['Kamis', '7A', 'Bagdady', 'IBNU', '09:25', '10:00'],
        ['Kamis', '7B', 'Bagdady', 'IBNU', '07:40', '08:15'],
        ['Kamis', '7B', 'Bagdady', 'IBNU', '08:15', '08:50'],
        ['Kamis', '7C', 'Bagdady', 'MARYAM', '07:40', '08:15'],
        ['Kamis', '7C', 'Bagdady', 'MARYAM', '08:15', '08:50'],
        ...
        ['Kamis', '7D', 'Bagdady', 'SARIFAH', '07:40', '08:15'],
        ['Kamis', '7D', 'Bagdady', 'SARIFAH', '08:15', '08:50'],
        ...
        ['Kamis', '9C', 'Qur\'an', 'ANIQOTUL', '07:40', '08:15'],
        ['Kamis', '9C', 'Qur\'an', 'ANIQOTUL', '08:15', '08:50'],
        ['Rabu', '7A', 'Akhlaq', 'NAHROWI', '08:50', '09:25'],
        ['Rabu', '7A', 'Akhlaq', 'NAHROWI', '09:25', '10:00'],
        ['Rabu', '7A', 'Bagdady', 'IBNU', '07:40', '08:15'],
        ['Rabu', '7A', 'Bagdady', 'IBNU', '08:15', '08:50'],
        ['Rabu', '7B', 'Bagdady', 'IBNU', '08:50', '09:25'],
        ['Rabu', '7B', 'Bagdady', 'IBNU', '09:25', '10:00'],
        ['Rabu', '7C', 'Bagdady', 'MARYAM', '08:50', '09:25'],
        ['Rabu', '7C', 'Bagdady', 'MARYAM', '09:25', '10:00'],
        ['Rabu', '7C', 'P. S&W', 'ANIQOTUL', '07:40', '08:15'],
        ['Rabu', '7C', 'P. S&W', 'ANIQOTUL', '08:15', '08:50'],
        ['Rabu', '7D', 'Bagdady', 'SARIFAH', '08:50', '09:25'],
        ['Rabu', '7D', 'Bagdady', 'SARIFAH', '09:25', '10:00'],
        ...
        ['Rabu', '9C', 'Akhlaq', 'HAFSAH', '08:15', '08:50'],
        ['Rabu', '9C', 'Juz Amma', 'ANIQOTUL', '08:50', '09:25'],
        ['Rabu', '9C', 'Juz Amma', 'ANIQOTUL', '09:25', '10:00'],
        ['Sabtu', '7C', 'Akhlaq', 'HAFSAH', '09:20', '09:55'],
        ['Sabtu', '7C', 'Akhlaq', 'HAFSAH', '09:55', '10:30'],
        ['Sabtu', '7D', 'Juz Amma', 'MARYAM', '09:20', '09:55'],
        ['Sabtu', '7D', 'Juz Amma', 'MARYAM', '09:55', '10:30'],
        ['Sabtu', '7D', 'P. S&W', 'ANIQOTUL', '10:30', '11:05'],
        ['Sabtu', '7D', 'P. S&W', 'ANIQOTUL', '11:05', '11:40'],
        ...
        ['Selasa', '7A', 'Bagdady', 'IBNU', '07:40', '08:15'],
        ['Selasa', '7A', 'Bagdady', 'IBNU', '08:15', '08:50'],
        ['Selasa', '7B', 'Bagdady', 'IBNU', '08:50', '09:25'],
        ['Selasa', '7B', 'Bagdady', 'IBNU', '09:25', '10:00'],
        ['Selasa', '7C', 'Bagdady', 'MARYAM', '08:50', '09:25'],
        ['Selasa', '7C', 'Bagdady', 'MARYAM', '09:25', '10:00'],
        ['Selasa', '7C', 'Fiqih', 'KHOLISOH', '07:40', '08:15'],
        ['Selasa', '7C', 'Fiqih', 'KHOLISOH', '08:15', '08:50'],
        ['Selasa', '7D', 'Bagdady', 'SARIFAH', '08:50', '09:25'],
        ['Selasa', '7D', 'Bagdady', 'SARIFAH', '09:25', '10:00'],
        ...
        ['Senin', '7A', 'Bagdady', 'IBNU', '08:50', '09:25'],
        ['Senin', '7A', 'Bagdady', 'IBNU', '09:25', '10:00'],
        ['Senin', '7B', 'Akhlaq', 'NAHROWI', '08:50', '09:25'],
        ['Senin', '7B', 'Akhlaq', 'NAHROWI', '09:25', '10:00'],
        ['Senin', '7B', 'Bagdady', 'IBNU', '07:40', '08:15'],
        ['Senin', '7B', 'Bagdady', 'IBNU', '08:15', '08:50'],
        ['Senin', '7C', 'Bagdady', 'MARYAM', '07:40', '08:15'],
        ['Senin', '7C', 'Bagdady', 'MARYAM', '08:15', '08:50'],
        ['Senin', '7C', 'Tauhid', 'NISFAH', '08:50', '09:25'],
        ['Senin', '7C', 'Tauhid', 'NISFAH', '09:25', '10:00'],
        ['Senin', '7D', 'Bagdady', 'SARIFAH', '07:40', '08:15'],
        ['Senin', '7D', 'Bagdady', 'SARIFAH', '08:15', '08:50'],
        ...
        foreach (self::MAPELS as $mapel) {
            MapelPlus::updateOrCreate(
                ...
                [
                    ...
                    'punya_progres_hafalan' => in_array($mapel['kode'], ['QURAN', 'JUZ_AMMA']),
                ]
            );
        }
    }
