...
class DataPesantrenSeeder extends Seeder
{
    ...
    private const MAPELS = [
        ...
        ['kode' => 'BAGDADY', 'nama' => 'Eja Baghdadi', 'nama_ar' => 'قاعدة بغدادية', 'kkm_default' => 70, 'urutan' => 2],
    ...
    private const GURUS = [
        ...
        'MARYAM' => ['nama' => 'SITI MARYAM', 'mengajar' => ['Eja Baghdadi' => ['7C']]],
        'IBNU' => ['nama' => 'IBNU MUHAJAR', 'mengajar' => ['Eja Baghdadi' => ['7A', '7B']]],
        'SARIFAH' => ['nama' => 'SARIFAH', 'mengajar' => ['Eja Baghdadi' => ['7D']]],
    ];
    ...
    private const JADWAL = [
        ['Kamis', '7A', 'Eja Baghdadi', 'IBNU', '08:50', '09:25'],
        ['Kamis', '7A', 'Eja Baghdadi', 'IBNU', '09:25', '10:00'],
        ['Kamis', '7B', 'Eja Baghdadi', 'IBNU', '07:40', '08:15'],
        ['Kamis', '7B', 'Eja Baghdadi', 'IBNU', '08:15', '08:50'],
        ['Kamis', '7C', 'Eja Baghdadi', 'MARYAM', '07:40', '08:15'],
        ['Kamis', '7C', 'Eja Baghdadi', 'MARYAM', '08:15', '08:50'],
        ...
        ['Kamis', '7D', 'Eja Baghdadi', 'SARIFAH', '07:40', '08:15'],
        ['Kamis', '7D', 'Eja Baghdadi', 'SARIFAH', '08:15', '08:50'],
        ...
        ['Rabu', '7A', 'Eja Baghdadi', 'IBNU', '07:40', '08:15'],
        ['Rabu', '7A', 'Eja Baghdadi', 'IBNU', '08:15', '08:50'],
        ['Rabu', '7B', 'Eja Baghdadi', 'IBNU', '08:50', '09:25'],
        ['Rabu', '7B', 'Eja Baghdadi', 'IBNU', '09:25', '10:00'],
        ['Rabu', '7C', 'Eja Baghdadi', 'MARYAM', '08:50', '09:25'],
        ['Rabu', '7C', 'Eja Baghdadi', 'MARYAM', '09:25', '10:00'],
        ['Rabu', '7D', 'Eja Baghdadi', 'SARIFAH', '08:50', '09:25'],
        ['Rabu', '7D', 'Eja Baghdadi', 'SARIFAH', '09:25', '10:00'],
        ...
        ['Selasa', '7A', 'Eja Baghdadi', 'IBNU', '07:40', '08:15'],
        ['Selasa', '7A', 'Eja Baghdadi', 'IBNU', '08:15', '08:50'],
        ['Selasa', '7B', 'Eja Baghdadi', 'IBNU', '08:50', '09:25'],
        ['Selasa', '7B', 'Eja Baghdadi', 'IBNU', '09:25', '10:00'],
        ['Selasa', '7C', 'Eja Baghdadi', 'MARYAM', '08:50', '09:25'],
        ['Selasa', '7C', 'Eja Baghdadi', 'MARYAM', '09:25', '10:00'],
        ['Selasa', '7C', 'Fiqih', 'KHOLISOH', '07:40', '08:15'],
        ['Selasa', '7C', 'Fiqih', 'KHOLISOH', '08:15', '08:50'],
        ['Selasa', '7D', 'Eja Baghdadi', 'SARIFAH', '08:50', '09:25'],
        ['Selasa', '7D', 'Eja Baghdadi', 'SARIFAH', '09:25', '10:00'],
        ...
        ['Senin', '7A', 'Eja Baghdadi', 'IBNU', '08:50', '09:25'],
        ['Senin', '7A', 'Eja Baghdadi', 'IBNU', '09:25', '10:00'],
        ['Senin', '7B', 'Akhlaq', 'NAHROWI', '08:50', '09:25'],
        ['Senin', '7B', 'Akhlaq', 'NAHROWI', '09:25', '10:00'],
        ['Senin', '7B', 'Eja Baghdadi', 'IBNU', '07:40', '08:15'],
        ['Senin', '7B', 'Eja Baghdadi', 'IBNU', '08:15', '08:50'],
        ['Senin', '7C', 'Eja Baghdadi', 'MARYAM', '07:40', '08:15'],
        ['Senin', '7C', 'Eja Baghdadi', 'MARYAM', '08:15', '08:50'],
        ['Senin', '7C', 'Tauhid', 'NISFAH', '08:50', '09:25'],
        ['Senin', '7C', 'Tauhid', 'NISFAH', '09:25', '10:00'],
        ['Senin', '7D', 'Eja Baghdadi', 'SARIFAH', '07:40', '08:15'],
        ['Senin', '7D', 'Eja Baghdadi', 'SARIFAH', '08:15', '08:50'],
