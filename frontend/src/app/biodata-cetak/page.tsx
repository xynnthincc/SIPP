...
export default function BiodataCetakPage() {
  return (
        ...
        {loading && id ? (
          ...
          <div className="py-10">
            <Alert variant="danger">
              Parameter id siswa tidak ditemukan. Silakan buka melalui menu Data Siswa atau Cetak Rapor.
            </Alert>
          </div>
        ) : error ? (
          <div className="py-10">
